...
(async () => {
  ...
  await fs.writeFile("aplastic-anaemias-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("aplastic-anaemias-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
